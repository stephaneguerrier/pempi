...
> library(tikzDevice)
> library(cape)
> tikz("casestudy.tex", width = 6, height = 5.4)
> # Data
> R1 = 32
> R2 = 0
> R3 = 39
...
> cols2 = gg_color_hue(2, alpha = 0.12)
> plot(NA, xlim = 100*range(beta), ylim = c(1, 4), axes = FALSE, ann = FALSE)
> grid()
> box()
> axis(1)
> axis(2)
...
> library(tikzDevice)
> library(cape)
> tikz("casestudy_bw.tex", width = 6, height = 5.4)
> # Data
> R1 = 32
> R2 = 0
> R3 = 39
...
> cols2 = c(t_col(cols[1], percent = 5), t_col(cols[2], percent = 5))
> plot(NA, xlim = 100*range(beta), ylim = c(1, 4), axes = FALSE, ann = FALSE)
> grid()
> box()
> axis(1)
