...
legend(0, 0.4, c("SMLE", "MMLE", "MME"), col = cols[c(1,3,2)],
       lwd = 2, bty = "n", cex = 1.2)
...
lines(simu$pi0[1:30]/100, cov_mle[1:30], col = col_cmle, pch = 16, type = "l", lwd = 2)
lines(simu$pi0[1:30]/100, cov_mmle[1:30], col = cols[3], pch = 16, type = "l", lwd = 2)
...
lines(simu$pi0[31:60]/100,      cov_mmle[31:60], col = cols[3], pch = 16, type = "l", lwd = 2)
lines(simu$pi0[31:60]/100,      cov_mle[31:60], col = col_cmle, pch = 16, type = "l", lwd = 2)
...
lines(simu$pi0[61:90]/100,      cov_mle[61:90], col = col_cmle, pch = 16, type = "l", lwd = 2)
lines(simu$pi0[61:90]/100,      cov_mmle[61:90], col = cols[3], pch = 16, type = "l", lwd = 2)
...
lines(simu$pi0[91:120]/100,      cov_mle[91:120], col = col_cmle, pch = 16, type = "l", lwd = 2)
lines(simu$pi0[91:120]/100,      cov_mmle[91:120], col = cols[3], pch = 16, type = "l", lwd = 2)
...
lines(simu$pi0[121:150]/100,      cov_mle[121:150], col = col_cmle, pch = 16, type = "l", lwd = 2)
lines(simu$pi0[121:150]/100,      cov_mmle[121:150], col = cols[3], pch = 16, type = "l", lwd = 2)
...
lines(simu$pi0[151:180]/100,      cov_mle[151:180], col = col_cmle, pch = 16, type = "l", lwd = 2)
lines(simu$pi0[151:180]/100,      cov_mmle[151:180], col = cols[3], pch = 16, type = "l", lwd = 2)
...
lines(simu$pi0[181:210]/100,      cov_mle[181:210], col = col_cmle, pch = 16, type = "l", lwd = 2)
...
legend("bottomleft", c("SMLE - CP", "SMLE - Asym", "CMLE - Asym.", "MMLE - Asym.", "MME - CP", "MME - Asym."), col = c(cols[c(1, 1)], col_cmle, cols[c(3, 2, 2)]),
       lwd = 2, lty = c(2, 1, 1, 1, 2, 1), bty = "n", cex = 1.1)
...
lines(simu$pi0[211:240]/100,      cov_mle[211:240], col = col_cmle, pch = 16, type = "l", lwd = 2)
lines(simu$pi0[211:240]/100,      cov_mmle[211:240], col = cols[3], pch = 16, type = "l", lwd = 2)
...
lines(simu$pi0[241:270]/100,      cov_mle[241:270], col = col_cmle, pch = 16, type = "l", lwd = 2)
lines(simu$pi0[241:270]/100,      cov_mmle[241:270], col = cols[3], pch = 16, type = "l", lwd = 2)
...
legend("topleft", c("SMLE - CP", "SMLE - Asym.",
                    "MMLE - Asym.", "MME - CP", "MME - Asym."),
       col = cols[c(1, 1, 3, 2, 2)],
