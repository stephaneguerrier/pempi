...
<<graph3bw>>=
library(tikzDevice)
tikz("length_bw.tex", width = 6, height = 5.4)
...
box()
abline(h = 95, lwd = 2, lty = 2)
lines(simu$pi0[1:30]/100, len_survey[1:30]/len_mle[1:30], col = cols[1], pch = 15, type = "l", lwd = 2, lty = 3)
lines(simu$pi0[1:30]/100, len_mmle[1:30]/len_mle[1:30], col = cols[3], pch = 16, type = "l", lwd = 2, lty = 2)
lines(simu$pi0[1:30]/100, len_mom_cp[1:30]/len_mle[1:30], col = cols[2], pch = 17, type = "l", lwd = 2)
#lines(simu$pi0[1:30]/100, cov_mom_asym[1:30], col = cols[2], pch = 17, type = "l", lwd = 2, lty = 2)
...
box()
abline(h = 95, lwd = 2, lty = 2)
lines(simu$pi0[31:60]/100, len_survey[31:60]/len_mle[31:60], col = cols[1], pch = 15, type = "l", lwd = 2, lty = 3)
lines(simu$pi0[31:60]/100, len_mmle[31:60]/len_mle[31:60], col = cols[3], pch = 16, type = "l", lwd = 2, lty = 2)
lines(simu$pi0[31:60]/100, len_mom_cp[31:60]/len_mle[31:60], col = cols[2], pch = 17, type = "l", lwd = 2)
#lines(simu$pi0[1:30]/100, cov_mom_asym[1:30], col = cols[2], pch = 17, type = "l", lwd = 2, lty = 2)
...
box()
abline(h = 95, lwd = 2, lty = 2)
lines(simu$pi0[61:90]/100, len_survey[61:90]/len_mle[61:90], col = cols[1], pch = 15, type = "l", lwd = 2, lty = 3)
lines(simu$pi0[61:90]/100, len_mmle[61:90]/len_mle[61:90], col = cols[3], pch = 16, type = "l", lwd = 2, lty = 2)
lines(simu$pi0[61:90]/100, len_mom_cp[61:90]/len_mle[61:90], col = cols[2], pch = 17, type = "l", lwd = 2)
#lines(simu$pi0[1:30]/100, cov_mom_asym[1:30], col = cols[2], pch = 17, type = "l", lwd = 2, lty = 2)
