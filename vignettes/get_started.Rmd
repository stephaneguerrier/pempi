...
Considering the following measurement error $\alpha = 0.01$, $\alpha_0 = 0$ and $\beta = 0.1$, we obtain:
...
Since we have that $\mathbb{E}[\widetilde{\pi} ] = \pi$, the MME is unbiased.
