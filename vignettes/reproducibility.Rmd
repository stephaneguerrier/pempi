...
# 1. Case study: Application to Austrian COVID-19 survey
...
# 1.1.1 Survey MLE with random sampling
...
# 1.1.2 Survey MLE with stratified sampling
...
# 1.2 Moment-based estimator 

# 1.2.1 Moment-based estimator with random sampling
...
# 1.2.2 Moment-based estimator with stratified sampling
...
# 1.3.1 Conditional MLE with random sampling
...
# 1.3.2 Conditional MLE with stratified sampling
...
# 1.3.1 Marginal MLE with random sampling
...
The results summarized in Appendix C and presented in Appendix D of @guerrier2020prevalence can be replicated as follows:
