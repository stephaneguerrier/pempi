...
1. Run the file `cape/simulations/simulation_script.R` which should take a couple of hours on a standard laptop.
2. Run the file `cape/simulations/figures.Rnw` to generates Figures 2, 3 and 4 (as well as color versions of these figures).
