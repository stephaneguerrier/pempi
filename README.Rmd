...
The ContionAl Prevalence Estimation (cape) package, allows to estimate and build confidence intervals for proportions, from random samples and census data with participation bias. Measurement errors in the form of false positive and false negative are also included the the inferential procedure. The cape package also contains code for simulation studies and sensitivity analysis reported in the companion paper @guerrier2020prevalence.

# Remark on notation

The notation and conventions used in @guerrier2020prevalence and slightly amended for convenience in this package. In particular, we used R1 instead R11, R2 instead of R10, R3 instead of R01 and R4 instead of R00.
