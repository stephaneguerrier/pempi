...
The `pempi` package is available on both CRAN and GitHub. The CRAN version is considered stable while the GitHub version is subject to modifications/updates which may lead to installation problems or broken functions. You can install the stable version of the `pempi` package with:
...
Guerrier, Stéphane, Christoph Kuzmics, and Maria-Pia Victoria-Feser. 2023. "Assessing COVID-19 Prevalence in Austria  with Infection Surveys and Case Count Data as Auxiliary Information", [https://arxiv.org/abs/2012.10745](https://arxiv.org/abs/2012.10745).
