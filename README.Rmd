...
The notation and conventions used in @guerrier2020prevalence are slightly amended for convenience in this package. In particular, we use R1 instead R11, R2 instead of R10, R3 instead of R01 and R4 instead of R00.
